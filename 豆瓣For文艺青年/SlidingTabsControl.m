                   ...
                   delegate:(NSObject <SlidingTabsControlDelegate>*)slidingTabsControlDelegate 
{
    if ((self = [super init]))
    {
        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 40, 320, 480)];
        ...
        // Draw our tab!
        _tab = [[SlidingTabsTab alloc] initWithFrame:CGRectMake(-5, 0, buttonWidth+10, buttonHeight)];
        ...
        for (NSUInteger i = 0 ; i < tabCount ; i++)
        {
            ...
            label.shadowColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.35];
